...
//Description: An application which creates a UI for the madison hotel application, implementing all functionality from
//part 1 of the project.
//Authors: Andrew Taylor, Brendan Boyle, George Moya, Dylan Vetter, Mark Kilgore
...
public class MadisonHotelJavaFX extends Application
{
    ...
    //load room service objects from database
    ...
    //start method which calls login with loginStage parameter and calls
    //methods from above to load in database content
    ...
    //method which handles login and displaying this stage
    ...
    //method which handles the guest menu and all of its sub menus.
    //makes use of tab pane to display all different functionalities
    //in their own tabs
...
//        });        
    ...
    //method which handles employee menu. uses tab pane to
    //display all different functionalities
    ...
    //method used to create a room, called from within create/edit room tab
    //on employee menu
    ...
    //method used to display a window to select a room, called from
    //employee menu in select/edit room tab
    ...
    //method to edit selected room from select room method above, room to be
    //edited is sent in as an int to specify its location in the arraylist
    ...
    //method to check if a room number sent in as a parameter
    //is valid
    ...
    //method to check if room price sent in as a parameter
    //is valid
    ...
    //method used to change guest name
    ...
    //method used to change employee name
    ...
    //overloaded method used for employees to change passwords
    ...
    //called as script shuts down, inserts values into DB
    public void stop()
    {
        insertRoom();
        insertEmployee();
    ...
    //application's main method which launches the app
    public static void main(String args[])
    {                
        Application.launch(args);
    }
    
    //method that prints a blank line
    public static void print()
    {
        System.out.println(" ");
    }
    
    //method used to insert room into DB
    ...
    //method used to update room in DB
    ...
    //method used to insert employees into DB
    ...
    //method used to update employee in DB
    ...
    //method used to insert room service into DB
    ...
    //method used to update room service in DB
    ...
    //method used to insert guest into DB
    ...
    //method used to update guest in DB
    ...
    //method used to insert booking into DB
    ...
    //method used to update booking in DB
    ...
    //method used to send sql command to DB
    ...
    //overloaded senddbcommand with extra parameters for room service
